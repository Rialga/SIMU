...
public class KelasAdapter extends RecyclerView.Adapter<KelasAdapter.AdapterViewholder>{
    ...
    public void onBindViewHolder(@NonNull AdapterViewholder holder, int position) {
        try {
            ...
            holder.ruang_ujian.setText(datakelas.getJSONObject(position).getString("ruang_ujian"));
            ...
            holder.tanggal_ujian.setText(datakelas.getJSONObject(position).getString("tanggal_ujian"));
